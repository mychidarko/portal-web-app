                    ...
                    <form onSubmit={send} className="box-body">
                        ...
                        <div className="input-group">
                            ...
                            <select className="form-control" value={transferFrom} onChange={onchangeText} name="transferFrom">
                                ...
                                {mobileMoney === "unlinked" ? null: <option value="mobile">Mobile Wallet</option>}
                        ...
                        {mobileMoney === "unlinked" ? (
                            <React.Fragment>
                                <h6>You have not linked your mobile wallet, hence you cannot send or recive cash through mobile wallet</h6>
                                <Link to="/settings/link-mobile">Link your mobile wallet here</Link>
                                <br/>
                            </React.Fragment>
                        ) : null}
                        <br />
